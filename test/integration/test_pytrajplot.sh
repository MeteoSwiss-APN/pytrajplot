...
pytrajplot $input_dir_tests/hres/4_altitudes $output_dir_tests/hres/4_altitudes --datatype png --domain europe
pytrajplot $input_dir_tests/hres/3_altitudes $output_dir_tests/hres/3_altitudes --datatype png --domain europe
pytrajplot $input_dir_tests/hres/2_altitudes $output_dir_tests/hres/2_altitudes --datatype png --domain europe
pytrajplot $input_dir_tests/hres/1_altitudes $output_dir_tests/hres/1_altitudes --datatype png --domain europe

echo "Test HRES backward trajectory"
pytrajplot $input_dir_tests/hres/backward $output_dir_tests/hres/backward --datatype png --domain europe --domain dynamic

echo "Test all domains combined w/ HRES model"
pytrajplot $input_dir_tests/hres/4_altitudes $output_dir_tests/hres/4_altitudes --datatype png --domain ch --domain alps --domain centraleurope --domain europe --domain dynamic

echo "Test HRES dateline crossing"
pytrajplot $input_dir_tests/hres/dateline $output_dir_tests/hres/dateline --datatype png --domain dynamic

echo "Test HRES w/o side trajectories and the german case"
pytrajplot $input_dir_tests/hres/dateline $output_dir_tests/hres/dateline/german --datatype png --domain dynamic --language de
...
pytrajplot $input_dir_tests/hres/zero_lon_from_east $output_dir_tests/hres/zero_lon_from_east
...
pytrajplot $input_dir_tests/hres/zero_last_lon $output_dir_tests/hres/zero_last_lon

echo "Test HRES trajectories crossing both 0 lon line and dateline"
pytrajplot  $input_dir_tests/hres/zero_lon_dateline $output_dir_tests/hres/zero_lon_dateline  --datatype png --domain dynamic
