...
if domain == "dynamic":
    ...
    if current_aspect_ratio < min_aspect_ratio:
        ...
        custom_domain_boundaries[0] -= additional_longitude / 2  # Expand west boundary
        custom_domain_boundaries[1] += additional_longitude / 2  # Expand east boundary
    ...
    if current_aspect_ratio > max_aspect_ratio:
        ...
        custom_domain_boundaries[2] = max(-90 + padding, custom_domain_boundaries[2] - additional_latitude / 2)  # Contract south boundary
        custom_domain_boundaries[3] = min(90 - padding, custom_domain_boundaries[3] + additional_latitude / 2)  # Contract north boundary
    domain_dict = {
        "centraleurope": {
